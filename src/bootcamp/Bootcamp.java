...
public class Bootcamp {
	...
	private Set<Desenvolvedores> devsInscritos = new HashSet<>();
	...
	public Set<Desenvolvedores> getDevsInscritos() {
		return devsInscritos;
	}
	public void setDevsInscritos(Set<Desenvolvedores> devsInscritos) {
